...
class UICellMenuTab: UICollectionViewCell{
    ...
    override init(frame: CGRect) {
        ...
        addConstraint(NSLayoutConstraint(item: iconMenu, attribute: .width, relatedBy: .equal, toItem: iconMenu, attribute: .height, multiplier: 1, constant: 0))
